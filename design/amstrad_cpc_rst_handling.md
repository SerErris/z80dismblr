# Amstrad CPC RST Instruction Handling for z80dismblr
...
`z80dismblr` by maziac implements a full CFG approach and is written in
...
The code changes described in this document apply to the `z80dismblr` source tree (`src/`).
...
// ============================================================================
// src/cpcRst.ts
// Amstrad CPC extended RST instruction support for z80dismblr.
// ============================================================================
...
`z80dismblr` has **no built-in data-range or block-definition file**.
...
Add the following cases to the argument parsing loop in `z80dismblr.ts`:
...
| Feature | Original z80dismblr | Our CPC Extension |
|---------|--------------------|--------------------|
