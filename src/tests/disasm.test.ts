	...
	suite('disassemble', () => {
		...
		test('main instructions', () => {
			const combined = [
				...
				0x31, 0x12, 0x34, "LD SP,EXT002",
				0x32, 0x12, 0x34, "LD (EXT002),A",
				0x33, "INC SP",
				0x34, "INC (HL)",
				0x35, "DEC (HL)",
				0x36, 0x0A, "LD (HL),0Ah",
...
/* 1125h */		0xEA, 0x04, 0x10, "JP PE,SUB002",
		...
		test('ED (extended instructions)', () => {
			const combined = [
				...
				0xED, 0x41, "OUT (C),B",
				0xED, 0x42, "SBC HL,BC",
				0xED, 0x43, 0x12, 0x34, "LD (EXT001),BC",
				0xED, 0x44, "NEG",
				...
				0xED, 0x49, "OUT (C),C",
				0xED, 0x4A, "ADC HL,BC",
				0xED, 0x4B, 0x12, 0x34, "LD BC,(EXT001)",
				0xED, 0x4C, "[neg]",
				...
				0xED, 0x51, "OUT (C),D",
				0xED, 0x52, "SBC HL,DE",
				0xED, 0x53, 0x12, 0x34, "LD (EXT001),DE",
				0xED, 0x54, "[neg]",
				0xED, 0x55, "[retn]",
				0xED, 0x56, "IM 1",
				0xED, 0x57, "LD A,I",
				...
				0xED, 0x59, "OUT (C),E",
				0xED, 0x5A, "ADC HL,DE",
				0xED, 0x5B, 0x12, 0x34, "LD DE,(EXT001)",
				0xED, 0x5C, "[neg]",
				0xED, 0x5D, "[reti]",
				0xED, 0x5E, "IM 2",
				0xED, 0x5F, "LD A,R",
				...
				0xED, 0x61, "OUT (C),H",
				0xED, 0x62, "SBC HL,HL",
				0xED, 0x63, 0x12, 0x34, "LD (EXT001),HL",
				0xED, 0x64, "[neg]",
				0xED, 0x65, "[retn]",
				0xED, 0x66, "[im0]",
				0xED, 0x67, "RRD",
				...
				0xED, 0x69, "OUT (C),L",
				0xED, 0x6A, "ADC HL,HL",
				0xED, 0x6B, 0x12, 0x34, "LD HL,(EXT001)",
				0xED, 0x6C, "[neg]",
				0xED, 0x6D, "[reti]",
				0xED, 0x6E, "[im0]",
				0xED, 0x6F, "RLD",
				...
				0xED, 0x71, "OUT (C),F",
				0xED, 0x72, "SBC HL,SP",
				0xED, 0x73, 0x12, 0x34, "LD (EXT001),SP",
				0xED, 0x74, "[neg]",
				0xED, 0x75, "[retn]",
				0xED, 0x76, "[im1]",
				0xED, 0x77, "[ld i,i?]",
				...
				0xED, 0x79, "OUT (C),A",
				0xED, 0x7A, "ADC HL,SP",
				0xED, 0x7B, 0x12, 0x34, "LD SP,(EXT001)",
				0xED, 0x7C, "[neg]",
				0xED, 0x7D, "[reti]",
				0xED, 0x7E, "[im2]",
				0xED, 0x7F, "[ld r,r?]",
		...
		test('DD (IX instructions)', () => {
			const combined = [
				...
				0xDD, 0x22, 0x12, 0x34, "LD (EXT001),IX",
				0xDD, 0x23, "INC IX",
				0xDD, 0x24, "INC IXH",
				0xDD, 0x25, "DEC IXH",
				0xDD, 0x26, 0x0A, "LD IXH,0Ah",
				0xDD, 0x29, "ADD IX,IX",
				0xDD, 0x2A, 0x12, 0x34, "LD IX,(EXT001)",
				0xDD, 0x2B, "DEC IX",
				0xDD, 0x2C, "INC IXL",
				0xDD, 0x2D, "DEC IXL",
		...
		test('FD (IY instructions)', () => {
			const combined = [
				...
				0xFD, 0x22, 0x12, 0x34, "LD (EXT001),IY",
				0xFD, 0x23, "INC IY",
				0xFD, 0x24, "INC IYH",
				0xFD, 0x25, "DEC IYH",
				0xFD, 0x26, 0x0A, "LD IYH,0Ah",
				0xFD, 0x29, "ADD IY,IY",
				0xFD, 0x2A, 0x12, 0x34, "LD IY,(EXT001)",
				0xFD, 0x2B, "DEC IY",
				0xFD, 0x2C, "INC IYL",
				0xFD, 0x2D, "DEC IYL",
